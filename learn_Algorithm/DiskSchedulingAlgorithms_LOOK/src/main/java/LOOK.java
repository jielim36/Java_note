...
public class LOOK {
    ...
    public static void LOOK(int arr[], int head, String direction)
    {
        ...
        //array content:{ 176, 79, 34, 60, 92, 11, 41, 114 }
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        // Request array
        int arr[] = { 176, 79, 34, 60, 92, 11, 41, 114 };//request queue, disk contain(0-199)
        int head = 50;//aim(initial position)
        String direction = "right";//direction is towards large value
